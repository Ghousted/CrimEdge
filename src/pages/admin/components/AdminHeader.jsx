            ...
            <div className="absolute right-0 mt-2 w-[280px] bg-white rounded-lg shadow-lg z-50 border border-gray-100">
              ...
              <ul className="m-0 p-0 list-none">
                <Link to="/admin/users" className='no-underline'>
                  <li className="p-[10px] px-[18px] cursor-pointer text-[#2d2f31] font-medium border-b border-gray-100 hover:bg-gray-100">User Management</li>
                </Link>
                <Link to="/admin/settings" className='no-underline'>
                  <li className="p-[10px] px-[18px] cursor-pointer text-[#2d2f31] font-medium border-b border-gray-100 hover:bg-gray-100">Settings</li>
                </Link>
                <li
                  onClick={handleLogout}
                  className="px-[18px] py-2.5 cursor-pointer text-red-500 font-medium hover:bg-red-50 transition-colors"
                >
                  Sign out
                </li>
              </ul>
