  ...
  const sections = [
    {
      ...
      lectures: [
        { title: '1. What is PowerApps?', duration: '2min', completed: true },
        { title: '2. Course tips', duration: '1min', completed: true },
        { title: '3. PowerApps Features', duration: '3min', completed: true },
        { title: '4. Why learn PowerApps?', duration: '2min', completed: true },
        { title: '5. Instructor overview', duration: '1min', completed: true },
        { title: '6. Ways to reach out', duration: '2min', completed: true },
        { title: '7. Keys to Success', duration: '2min', completed: false },
        { title: '8. Course overview', duration: '3min', completed: true },
        { title: '9. Additional material', duration: '2min', completed: true },
        { title: '10. Watch in 1080p', duration: '1min', completed: true },
      ],
    },
    {
      title: 'Section 2: Environment Setup',
      lectures: [
        { title: '1. Install PowerApps', duration: '4min', completed: false },
        { title: '2. Setup Account', duration: '3min', completed: false },
      ],
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="flex flex-col w-full gap-4 lg:col-span-2">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="bg-black rounded-lg shadow-lg aspect-video flex items-center justify-center relative mb-4">
                ...
                <div className="absolute bottom-2 left-0 right-0 flex items-center justify-between px-4">
                  <div className="flex items-center gap-2">
                    <button className="text-white"><i className="bi bi-play-fill"></i></button>
                    <span className="text-xs text-white">2:27 / 8:27</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <button className="text-white"><i className="bi bi-volume-up"></i></button>
                    <button className="text-white"><i className="bi bi-gear"></i></button>
                    <button className="text-white"><i className="bi bi-arrows-fullscreen"></i></button>
                  </div>
                </div>
                    ...
                    {expandedSections[idx] && (
                      <ul className="p-2">
                        {section.lectures.map((lec, lidx) => (
                          <li key={lidx} className="flex items-center gap-2 text-gray-700 text-sm p-2 hover:bg-gray-50 rounded-lg transition-colors duration-200">
                            <input type="checkbox" checked={lec.completed} readOnly className="accent-blue-600" />
                            <span>{lec.title}</span>
                            <span className="ml-auto text-xs text-gray-400">{lec.duration}</span>
                          </li>
                        ))}
                        <li className="mt-2">
                          <button
        ...
        <div className="modal-overlay">
          <div className="bg-white p-6 rounded-xl shadow-xl w-[90%] max-w-2xl">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-medium text-gray-800">Add New Lesson</h2>
              <button
                onClick={() => {
                  setShowAddLessonModal(false);
                  setLessonTitle('');
