                ...
                <div className="flex items-center gap-10 ">
                  ...
                  <div className="flex items-center gap-1 mb-3">
                    {[1, 2, 3, 4, 5].map(star => (
                      ...
                      >
                        <i
                          className={`bi ${newReviewStars >= star ? 'bi-star-fill text-amber-400' : 'bi-star text-gray-300'
                            } text-2xl`}
                        ></i>
                      </button>
                    ))}
                    ...
                    >
                      <div className="flex items-center gap-2 mb-2">
                        {[1, 2, 3, 4, 5].map(star => (
                          <i
                            key={star}
                            className={`bi ${r.stars >= star ? 'bi-star-fill text-amber-400' : 'bi-star text-gray-300'
                              } text-sm`}
                          ></i>
                        ))}
            ...
            <div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {studentAssessments.map(a => (
                  ...
                  >
                    <div className="mb-3">
                      <i className={`bi ${a.type === "Pre-Test" ? "bi-journal-check text-blue-600" :
            ...
            <div>
              ...
              <div className="flex justify-between items-center mb-4">
                <div className="flex flex-wrap items-center gap-6 mb-6">
                  ...
                  <button className="border border-gray-300 px-4 py-2 rounded-lg bg-white text-gray-800 font-medium flex items-center gap-2 text-sm hover:border-blue-600">
                    All lectures <i className="bi bi-chevron-down"></i>
                  </button>
                  <span className="font-semibold text-gray-700">Sort by:</span>
                  <button className="border border-gray-300 px-4 py-2 rounded-lg bg-white text-gray-800 font-medium flex items-center gap-2 text-sm hover:border-blue-600">
                    Sort by recommended <i className="bi bi-chevron-down"></i>
                  </button>
                  <button className="border border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white px-4 py-2 rounded-lg transition-all duration-200 flex items-center gap-2">
                    Filter questions <i className="bi bi-chevron-down"></i>
                  </button>
                </div>
                <button
              ...
              <div className="space-y-6 mt-6">
                {questions.map((q) => {
                  ...
                  return (
                    <div key={q.id} className="bg-white p-4 border border-gray-200 rounded-lg shadow-sm">
                      <h4 className="text-sm font-semibold text-blue-800 mb-1">
                        {lecture ? lecture.title : "Unknown Lecture"}
                      </h4>

                      <p className="text-xs text-gray-500 mb-1">
                        {q.createdBy} • {formatted}
                      </p>

                      <p className="text-sm text-gray-700 mb-3">{q.question}</p>

                      <div className="flex gap-4 items-center text-sm text-blue-500">
                        <button
                          onClick={() => setReplyBoxes((prev) => ({ ...prev, [q.id]: !prev[q.id] }))}
                        ...
                        <button
                          ...
                          className="hover:underline"
                        >
                          {isRepliesShown ? "Hide replies" : `View replies (${replies[q.id].length})`}
                        </button>
                      </div>
                          ...
                          <ul className="p-2">
                            {Array.isArray(lesson.lectures) && lesson.lectures.length > 0 ? (
                              lesson.lectures.map((lec, lidx) => (
                                <li
                                  key={lidx}
                                  className={`flex items-center gap-2 text-sm p-2 rounded-lg transition-colors duration-200 cursor-pointer ${selectedLecture && selectedLecture.id === lec.id
