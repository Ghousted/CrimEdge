        ...
        <section className={`p-6 text-center rounded-lg pt-10 ${darkMode ? ' text-gray-200' : ' text-gray-800'}`}>
          ...
          <div className="flex justify-center gap-4">
            <button
              ...
              className={`px-4 py-2 rounded font-semibold transition-colors ${darkMode
          ...
          return (
            <div className="space-y-6">
                  ...
                  <div>
                    <div className="flex items-center mb-1">
                      {[1, 2, 3, 4, 5].map(star => (
                        <i
                          key={star}
                          className={`bi bi-star-fill text-amber-400 text-xl transition ${star > Math.round(course?.rating || 4.3) ? 'opacity-30' : ''
                            }`}
                        ></i>
                      ))}
                    </div>
              ...
              <div className="mb-6">
                <div className="flex flex-wrap items-center gap-10 mb-3">
                  ...
                  <div className="flex items-center gap-1">
                    {[1, 2, 3, 4, 5].map(star => (
                      ...
                      >
                        <i
                          className={`bi ${newReviewStars >= star ? 'bi-star-fill text-amber-400' : 'bi-star text-gray-300 dark:text-gray-600'
                            } text-2xl`}
                        ></i>
                      </button>
                    ))}
                ...
                <div
                  className={`flex gap-2 w-full mb-4 border-b pb-4 ${darkMode ? 'border-gray-700' : 'border-gray-200'
                    }`}
                >
                  <input
                    type="text"
                ...
                {reviews.length === 0 ? (
                  ...
                  reviews
                    ...
                    .map(r => (
                      <div
                        key={r.id}
                        className={`rounded-lg p-4 shadow-sm hover:shadow-md transition border ${darkMode
                        ...
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <div className="flex gap-1">
                            {[1, 2, 3, 4, 5].map(star => (
                              <i
                                key={star}
                                className={`bi ${r.stars >= star ? 'bi-star-fill text-amber-400' : 'bi-star text-gray-300 dark:text-gray-600'
                                  } text-sm`}
                              ></i>
                            ))}
                          </div>
            ...
            <div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {studentAssessments.map((a) => (
                  <div
                    key={a.id}
                    className={`flex flex-col items-center justify-center rounded-xl p-8 transition-shadow hover:shadow-md text-center border ${darkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-300 shadow-md"
                      }`}
                  >
                    <div className="mb-3">
                      <i
                        className={`bi ${a.type === "Pre-Test"
                    ...
                    <div
                      className={`font-semibold text-lg mb-1 ${darkMode ? "text-white" : "text-gray-800"
                        }`}
                    >
                      {a.type}
                    </div>
              ...
              {studentAssessments.length === 0 && (
                <div
                  className={`text-center py-8 italic ${darkMode ? "text-gray-500" : "text-gray-400"
                    }`}
                >
            ...
            <div >
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-3 mb-6">
                <input
                  ...
                  className={`flex-1 rounded-lg px-4 py-2.5 text-sm shadow-sm transition-all border ${darkMode
                ...
                />
                <button
                  className={`rounded-lg px-4 py-2 text-sm font-medium shadow-sm transition flex items-center justify-center gap-2 ${darkMode
              ...
              <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-md border transition shadow-sm ${darkMode
                    ? "border-gray-700 text-gray-200 hover:border-blue-500"
                    : "border-gray-300 bg-white text-gray-800 hover:border-blue-600"
                    }`}
                >
              ...
              <div className="space-y-6">
                {questions.map((q) => {
                  ...
                  return (
                    <div
                      key={q.id}
                      className={`rounded-lg border shadow-sm transition ${darkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"
                        }`}
                    >
              ...
              <div>
                {quizzesLoading ? (
                  <div className="flex justify-center items-center py-16">
                    <div
                      className={`animate-spin rounded-full h-10 w-10 border-4 ${darkMode
                  ...
                  <div
                    className={`text-center py-12 rounded-lg border shadow-sm ${darkMode
                      ? "bg-gray-800 border-gray-700"
                      : "bg-white border-gray-200"
                      }`}
                  >
                    <i className={`bi bi-pencil-square text-5xl ${darkMode ? "text-gray-600" : "text-gray-300"
                      } mb-3`}></i>
                ...
                `}
                      >
                        <div className="flex flex-col justify-between h-full">
                          <div>
                            <h3 className={`text-lg font-semibold mb-1 ${darkMode ? "text-gray-200" : "text-gray-900"
                              }`}>
                              {quiz.title}
                            </h3>
                            <div className={`flex items-center flex-wrap gap-2 text-sm mb-3 ${darkMode ? "text-gray-400" : "text-gray-600"
                              }`}>
                              <span className={`px-2 py-0.5 rounded-full ${darkMode ? "bg-gray-700 text-gray-300" : "bg-gray-100 text-gray-700"
                                }`}>
                                📂 {quiz.topic}
                              </span>
                  ...
                  {lessons.length === 0 ? (
                    ...
                    lessons.map((lesson, idx) => (
                      <div key={idx} className={`border rounded-lg ${darkMode ? 'border-[#3E4042]' : 'border-gray-300'}`}>
                        <div
                          className={`flex items-center justify-between p-2 cursor-pointer transition-colors duration-200 ${darkMode ? 'bg-[#2c2c2e] hover:bg-[#3a3a3d]' : 'bg-gray-50 hover:bg-gray-100'
                            }`}
                        ...
                        >
                          ...
                          <button
                            className={`p-1 rounded-full transition-colors duration-200 relative z-50 ${darkMode
                          ...
                          >
                            ...
                            {dropdownOpen === `section-${idx}` && (
                              <div
                                className={`absolute right-0 top-0 mr-8 w-40 rounded-lg shadow-lg z-[100] overflow-hidden border ${darkMode ? 'bg-[#1f1f21] border-[#3E4042]' : 'bg-white border-gray-200'
                                  }`}
                              >
                                <button
                                  className={`flex items-center gap-1.5 w-full px-3 py-2 text-sm transition-colors duration-200 ${darkMode ? 'text-gray-200 hover:bg-[#2a2a2c]' : 'text-gray-700 hover:bg-gray-50'
                                    }`}
                                ...
                                <button
                                  className={`flex items-center gap-1.5 w-full px-3 py-2 text-sm transition-colors duration-200 ${darkMode ? 'text-red-400 hover:bg-[#2a2a2c]' : 'text-red-600 hover:bg-gray-50'
                                    }`}
                          ...
                          <ul className="p-2">
                            {Array.isArray(lesson.lectures) && lesson.lectures.length > 0 ? (
                              lesson.lectures.map((lec, lidx) => (
                                <li
                                  key={lidx}
                                  className={`flex items-center gap-2 text-sm p-2 rounded-lg cursor-pointer transition-colors duration-200 ${selectedLecture && selectedLecture.id === lec.id
                                    ? darkMode
                                    ...
                                    {lec.lectureFiles && lec.lectureFiles.length > 0 && (
                                      <div className="flex items-center gap-2 mt-1 flex-wrap">
                                        {lec.lectureFiles.map((file, index) => (
                                          <span
                                            key={index}
                                            className={`text-xs px-2 py-0.5 rounded-full flex items-center gap-1 ${darkMode ? 'bg-[#3a3a3d] text-gray-300' : 'bg-gray-100 text-gray-700'
                                              }`}
                                          >
                                            <i
                                              className={`bi ${file.fileType === 'application/pdf' ? 'bi-file-pdf' : 'bi-file-play'
                                                }`}
                                            ></i>
                                            {file.fileName}
                                          </span>
